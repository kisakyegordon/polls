...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_past_question(self):
        """
        Questions with a pub-date in the past should be displayed on the index 
        page.
        """
    ...
    def test_index_view_with_a_future_question(self):
        """
        Questions with pub-date in the future should not be displayed 
        on the front page.
        """
    ...
    def test_index_view_with_two_past_questions(self):
        """
        The questions index page might display multiple questions
        """
...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() should return True fir questions whose
